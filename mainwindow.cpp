    ...
    , ui(new Ui::MainWindow)
{
    ...
    for(int i =0;i<16;i++)
    {
        icons[i].load(QString::asprintf(":/C:/Users/86180/Desktop/images/%d.png",i));
    }
    //加载连线
    imageLine[0].load(":/C:/Users/86180/Desktop/images/line.png");
    QTransform transform;
    transform.rotate(90.0);
    //连线旋转九十度
    imageLine[1]=imageLine[0].transformed(transform,Qt::FastTransformation);
    //折线
    imageTurn[0].load(":/C:/Users/86180/Desktop/images/turn.png");
    for(int i =1;i<4;i++)
    {
    ...
    clickSound.setSource(QUrl::fromLocalFile(":/C:/Users/86180/Desktop/sound/click.wav"));
    clickSound.setVolume(0.5f);
    bgm.setSource(QUrl::fromLocalFile(":/C:/Users/86180/Desktop/sound/background.wav"));
    bgm.setVolume(0.5f);
